...
class updateForm(FlaskForm):
        ...
        firstName = StringField('First Name',validators=[Length(1,64)],render_kw={'style': 'width: 28ch'})
        lastName = StringField('Last Name',validators=[Length(1,64)],render_kw={'style': 'width: 28ch'})
